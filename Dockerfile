...
LABEL org.opencontainers.image.title="CFO Marketplace"
LABEL org.opencontainers.image.description="Production-ready Dockerfile for the CFO marketplace (Laravel Octane / FrankenPHP)"
...
# System dependencies + PHP extensions needed by the CFO marketplace.
RUN apt-get update; \
    apt-get upgrade -yqq; \
